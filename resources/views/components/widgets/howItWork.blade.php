<section class="container px-[.5rem] md:px-[0px] lg:px-[3rem] mx-auto py-[2.5rem] md:py-[5rem] ">
    <div class="space-y-4 md:space-y-6">
        ...
        <div class="flex justify-center">
            <div class="block md:flex items-center gap-2 space-y-4 w-full md:w-[90%]">
                ...
                <div class="hidden md:block">
                    <svg class="w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                        <path d="M0,50 C25,0 75,100 100,50" stroke="#f2722b" stroke-width="2" fill="none" />
                    </svg>
                </div>
