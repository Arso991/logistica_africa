    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="relative h-[350px] rounded-lg shadow-lg overflow-hidden group">
            ...
            <div class="absolute inset-0 bg-cover bg-center"
                style="background-image: url('{{ asset('assets/images/brand/machine3.jpg') }}');">
            ...
            <div
                ...
                <h2 class="text-sm sm:text-[1rem] font-semibold">Location d'engins et d'équipements</h2>
            </div>
            ...
            <div
                ...
                <h2 class="text-sm sm:text-[1rem] font-semibold mb-4">Location d'engins et d'équipements</h2>
                <p class="text-sm sm:text-[1rem] leading-7">
                    Nous mettons à votre disposition une flotte d'engins robustes, contrôlés et immédiatement
                    opérationnels
                    pour répondre à tous vos besoins : terrassement, nivellement, levage, transport… Profitez de
                    matériels
                    fiables et d'un accompagnement réactif pour sécuriser vos chantiers.
                </p>
            </div>
